const furnitures = [
  {
    varnish: ["Tan", "Chocolate", "Black", "White"],
  ...
  {
    varnish: ["Dark Oak", "Teak", "Mahogany"],
...
exports.find = () => {
  return new Promise((resolve, reject) =>
    resolve(JSON.parse(JSON.stringify(furnitures)))
  );
};
...
exports.findById = (id) => {
  return new Promise((resolve, reject) =>
    resolve(
      JSON.parse(JSON.stringify(furnitures)).find(
