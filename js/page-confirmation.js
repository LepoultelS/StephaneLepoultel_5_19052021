...
let orderProducts = searchParams.get("ids").split(",");
// convert ids string to array
let summary = document.getElementById("summary");

confirmationText.innerHTML = `
  Merci <strong> ${orderFirstName} ${orderLastName} </strong>, votre commande n° <strong> ${orderId}
  </strong> d'un montant de <strong> ${(orderTotal / 100).toFixed(
    2
